package com.victor.playground.config;

import com.github.mongobee.Mongobee;
import com.mongodb.Mongo;
import com.victor.playground.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("com.victor.playground.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.victor.playground.config.dbmigrations");
